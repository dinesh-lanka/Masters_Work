...
handles.value_checkbox_create_new_from_old_classifier = false;
handles.value_checkbox_create_new_classifier = false;
handles.value_checkbox_new_negatives = 0;
handles.value_checkbox_old_negatives = 0;
handles.value_checkbox_both_negatives = 0;
handles.value_edit_negative_samples_factor = 2;
...
if handles.value_checkbox_create_new_from_old_classifier == 1
    createImageListFromOldNewImages(handles.value_edit_newimage_folder_path,handles.new_image_type,handles.value_edit_image_folder_path,handles.image_type,handles.value_edit_destination_folder,handles.value_edit_imageList_filename);
    handles.value_edit_progress_bar = 'Image List is created from new new & old images and saved';
    set(handles.edit_progress_bar,'string',handles.value_edit_progress_bar);
    flagForPositives = 1;
end
if handles.value_checkbox_create_new_classifier == 1 && flagForPositives == 0
    handles.value_edit_image_folder_path = createImageListFromNewImages(handles.value_edit_newimage_folder_path,handles.new_image_type,handles.value_edit_destination_folder,handles.value_edit_imageList_filename);
    handles.value_edit_progress_bar = 'Image List is created from new images and saved';
    set(handles.edit_progress_bar,'string',handles.value_edit_progress_bar);
    flagForPositives = 1;
end
if handles.value_checkbox_both_negatives == 1
    useOldNewNegativeImages( handles.value_edit_new_negativeimage_folder_path,handles.value_edit_background_images_folder_path );
    flagForNegatives = 1;
end
if handles.value_checkbox_old_negatives == 1 ||  handles.value_checkbox_new_negatives == 1
    flagForNegatives = 1;
end
if flagForPositives == 0 &&  flagForNegatives == 1
    handles.value_edit_progress_bar = 'Some problem occured while creating positive image list. Please retry.';
    set(handles.edit_progress_bar,'string',handles.value_edit_progress_bar);
else
    if flagForPositives == 1 &&  flagForNegatives == 0
        handles.value_edit_progress_bar = 'Some problem occured while copying negative images to old images folder. Please retry.';
        set(handles.edit_progress_bar,'string',handles.value_edit_progress_bar);
    end
end
if flagForPositives == 1 &&  flagForNegatives == 1
    handles.value_edit_progress_bar = 'Positive and Negative Images are ready for training';
    set(handles.edit_progress_bar,'string',handles.value_edit_progress_bar);
end
...
handles.value_edit_progress_bar = 'Old negative images directory selected';
set(handles.edit_progress_bar,'string',handles.value_edit_progress_bar);
guidata(hObject,handles);
...
if handles.value_checkbox_new_negatives == 1
    handles.value_edit_background_images_folder_path = handles.value_edit_new_negativeimage_folder_path;
end
if handles.value_checkbox_old_negatives == 1 || handles.value_checkbox_both_negatives == 1
    handles.value_edit_background_images_folder_path = handles.value_edit_background_images_folder_path;
end
...
commandToExecute = sprintf('%s %s %s %s %s %d %s %d %s %d %d %s','cascadeTraining.exe',handles.value_edit_image_list_absolute_path,handles.value_edit_classifier_destination_path,handles.value_edit_image_folder_path,handles.value_edit_background_images_folder_path,handles.value_edit_number_of_training_stages,handles.value_edit_classifier_filename,handles.value_edit_negative_samples_factor,handles.image_training_size,handles.value_false_alarm_rate,handles.value_true_positive_rate,handles.feature_type);
[status,outputInfo] = system(commandToExecute);
handles.value_edit_progress_bar = 'Classifier training completed. Check status in display dialog box.';
set(handles.edit_progress_bar,'string',handles.value_edit_progress_bar);
helpdlg(outputInfo,'Output of Training');
guidata(hObject,handles);
...
if handles.value_checkbox_create_new_classifier == 1
    ...
    set(handles.edit_newimage_folder_path,'enable','on');
    set(handles.text_imageList_filename,'enable','on');
    set(handles.edit_imageList_filename,'enable','on');
    set(handles.text_destination_folderpath,'enable','on');
    set(handles.edit_destination_folder,'enable','on');
    set(handles.pushbutton_select_destination_folder_path,'enable','on');
else
    ...
    set(handles.edit_newimage_folder_path,'enable','off');
    set(handles.text_imageList_filename,'enable','off');
    set(handles.edit_imageList_filename,'enable','off');
    set(handles.text_destination_folderpath,'enable','off');
    set(handles.edit_destination_folder,'enable','off');
    set(handles.pushbutton_select_destination_folder_path,'enable','off');
end
guidata(hObject, handles);
...
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
handles.value_edit_new_negativeimage_folder_path = setFolderPath;
set(handles.edit_new_negativeimage_folder_path,'string',handles.value_edit_new_negativeimage_folder_path);
handles.value_edit_progress_bar = 'New negative images directory selected';
set(handles.edit_progress_bar,'string',handles.value_edit_progress_bar);
guidata(hObject,handles);
...
contents = cellstr(get(hObject,'String'));
handles.new_image_type = contents{get(hObject,'Value')};
handles.value_edit_progress_bar = 'Image type selected';
set(handles.edit_progress_bar,'string',handles.value_edit_progress_bar);
