...
detectorFilename='XML_Files\markerDetectorBlackBG.xml';
...
for i=1
    filepath='E:\GAC_Files\Images_From_Test_Runs\Cobra_Propeller\Cobra_prop\pictures\cam_1\FT_019918.bmp';
    imagefile=filepath;
